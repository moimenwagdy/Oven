...
// GoRouter createAppRouter(bool updateNeeded) {
//   return GoRouter(
//     navigatorKey: _rootNavigatorKey,
//     initialLocation: updateNeeded ? "/update" : "/",
//     routes: [
//       GoRoute(path: "/update", builder: (c, s) => const UpdatePage()),
//       ShellRoute(
...
//                         path: ':orderId',
//                         builder: (c, s) =>
//                             const OrderDetailsPage(orderId: 'mo'),
//                       ),
//                     ],
//                   ),
//                 ],
...
final GoRouter appRouter = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    final isOnUpdatePage = state.matchedLocation == '/update';

    if (updateNeeded && !isOnUpdatePage) {
      return '/update';
    }
    if (!updateNeeded && isOnUpdatePage) {
      return '/';
